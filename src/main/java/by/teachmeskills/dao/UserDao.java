...
import by.teachmeskills.util.ConnectionManager;
...
public class UserDao implements Dao<Integer, User>, Serializable {
    ...
    private static final String FIND_USER_BY_LOGIN_AND_PASSWORD = "select u.id, u.first_name, u.last_name, u.email, u.date_of_birth, ac.login, ac.password from users u join  auth_credentials ac on u.id =ac.user_id where ac.login = ? and ac.password = ?";
